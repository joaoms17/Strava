...
begin
  ...
  values
    (v_user, 'Bike zona 2', 'bike', true, null, null,
     'Bicicleta estática; 130/140/150 W; cadência >= 85 rpm; progressão por tempo: 30, 45, 60 min.'),
    (v_user, 'RDL com halteres', 'hinge', true, 8, 12, 'Hip hinge; costas neutras.'),
    (v_user, 'Glute bridge', 'bridge', true, 8, 12, null),
    ...
    (v_user, 'Extensão terminal do joelho com banda', 'isolamento-joelho', true, 8, 12,
    ...
    (v_user, 'Abdução de anca com banda', 'abducao', true, 8, 12, null),
    (v_user, 'Calf raise', 'gemeos', true, 8, 12, null),
    (v_user, 'Press de ombros com halteres', 'empurrar-vertical', true, 8, 12, null),
    (v_user, 'Elevações laterais', 'isolamento-ombro', true, 8, 12, null),
    ...
    (v_user, 'Pallof press com banda', 'core', true, 8, 12, 'Reps por lado.'),
